...
\item Our approach to treating interactions between extensions
  ...
  explored. 
  %
  Using examples from the extensibility libraries developed by the Van
  Wyk group, we will conduct experiments towards understanding the
...
While the work that we have proposed has its own intellectual
justification, the questions that it will investigate
